...
from cell_def import CellDefTab
...
titles = ['About', 'Config Basics', 'Microenvironment', 'Cells', 'User Params', 'Out: Plots']
#tabs = widgets.Tab(children=[about_tab.tab, config_tab.tab, microenv_tab.tab, user_tab.tab, svg.tab, sub.tab],
tabs = widgets.Tab(children=[about_tab.tab, config_tab.tab, microenv_tab.tab, cell_tab.tab, user_tab.tab, sub.tab],
...
sub.update_dropdown_fields("tmpdir")   # WARNING: generates multiple "<Figure size...>" stdout!
